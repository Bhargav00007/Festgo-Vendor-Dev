      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mt-4 sm:mt-0 flex items-center space-x-3">
              <div className="bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-200">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">{vendors.length} Active Vendors</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">With Properties</p>
                <p className="text-2xl font-bold text-gray-900">{vendors.filter(v => v.property?.id).length}</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h3 className="text-xl font-semibold text-gray-900">Vendor Directory</h3>
                <p className="mt-1 text-sm text-gray-500">Complete list of all registered vendors</p>
              </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Property Status</th>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-sm text-gray-500">{vendor.number || "N/A"}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="mt-1 text-xs text-gray-500">
                          {vendor.property?.id ? `Property: ${vendor.property.id.slice(0, 8)}...` : "No Property"}
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1 space-y-1">
                          <p className="text-xs text-gray-600">{vendor.email || "N/A"}</p>
                          <p className="text-xs text-gray-600">{vendor.number || "N/A"}</p>
                          <div className="flex items-center justify-between">
                            ...
                            <span className={`text-xs ${vendor.property?.id ? 'text-green-600' : 'text-gray-500'}`}>
                              {vendor.property?.id ? '● Property Linked' : '○ No Property'}
                            </span>
                          </div>
                        </div>
                      </div>
