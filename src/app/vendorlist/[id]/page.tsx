          ...
          {properties.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <p className="mt-2 text-sm text-gray-500">
                This vendor hasn&apos;t created any properties yet. Properties
                    ...
                    {properties.map((prop) => (
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="w-12 h-12 rounded-lg overflow-hidden border border-gray-200 bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
                              <Icon
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="space-y-1">
                            ...
                            <div className="text-sm text-gray-600">
                              {prop.location?.state || prop.state},{" "}
                  ...
                  {properties.map((prop) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="w-12 h-12 rounded-lg overflow-hidden border border-gray-200 flex-shrink-0 bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
                          <Icon
                            icon="solar:home-2-bold"
                            className="text-blue-600"
                            width={20}
