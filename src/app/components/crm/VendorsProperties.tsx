      ...
      <div className="grid grid-cols-12 gap-[10px] items-end">
        <div className="xl:col-span-5 col-span-7">
          <div>
            ...
            <span className="font-semibold border rounded-full border-black/5 dark:border-white/10 py-0.5 px-[10px] leading-[normal] text-xs bg-white rounded-full text-dark dark:text-darklink">
